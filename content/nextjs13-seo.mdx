    ...
    (
      <div
        style={{
          ...
          display: "flex",
          // more styles here...
          backgroundImage: "url(https://davidhtnguyen.com/og-bg.png)",
        }}
      >
        {title}
      </div>
...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const ogImage = `https://davidhtnguyen.com/api/og?title${title}`;
...
The [background image](https://davidhtnguyen.com/og-bg.png) I am using looks like this:
...
And the resulting [dynamically generated OG image](https://davidhtnguyen.com/api/og?title=Optimizing%20SEO%20with%20Next.js%2013%27s%20Metadata%20API) looks like this:
...
export default async function sitemap() {
  const blogs = allBlogs.map((post) => ({
    url: `https://davidhtnguyen.com/blog/${post.slug}`,
    lastModified: post.publishedAt,
  }));

  const routes = ["", "/projects", "/blog"].map((route) => ({
    url: `https://davidhtnguyen.com${route}`,
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://davidhtnguyen.com/blog/nextjs13-seo",
    images: [
      {
        url: "https://davidhtnguyen.com/api/og?title=Optimizing SEO with Next.js 13's Metadata API",
      },
    ],
  },
  twitter: {
    ...
    description:
      "A guide on how to optimize SEO with static and dynamic metatags using Next.js 13's new Metadata API.",
    images: [
      "https://davidhtnguyen.com/api/og?title=Optimizing SEO with Next.js 13's Metadata API",
    ],
  },
};
```
