  ...
  return (
    <main className={`${GeistMono.className} space-y-8 md:space-y-12`}>
      <InfoCard id="readme" title="davidnguyen / README.md">
        ...
        <h1 className="text-3xl font-bold md:text-4xl">David Nguyen.</h1>

        <p className="mt-4 text-lg font-medium text-gray-950 dark:text-white md:text-xl">
      ...
      <InfoCard id="featured-projects" title="featured projects">
        <span>
          ...
          <Link
            href="/projects"
            className="cursor-pointer text-black underline transition duration-150 ease-in-out hover:text-sky-600 dark:text-gray-50 dark:hover:text-sky-400"
          >
            click here
          </Link>
          .
